...
global.website = 'https://github.com/prabathLK/PRABATH-MD' //wa.me/+94788550084
...
module.exports = {
  ...
  botname: process.env.BOT_NAME || 'SANDUN-MD',
  ...
  alivemsj: process.env.ALIVE_MSJ || '*POWERD BY SANDUN-MD* 🎊',
  ownername:process.env.OWNER_NAME || 'SANDUN',
